...
class MaterialTheme {
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff314c63),
      onTertiaryContainer: Color(0xffffffff),
      ...
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff314c63),
      onTertiaryFixed: Color(0xffffffff),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiaryFixedDim: Color(0xffaec9e6),
      onTertiaryFixedVariant: Color(0xff1c384f),
      surfaceDim: Color(0xff0e1514),
  ...
  static const customColor1 = ExtendedColor(
    seed: Color(0xff2bbbad),
    value: Color(0xff2bbbad),
    light: ColorFamily(
      color: Color(0xff006a62),
      onColor: Color(0xffffffff),
      colorContainer: Color(0xff9ef2e6),
      onColorContainer: Color(0xff005049),
    ),
    ...
    dark: ColorFamily(
      color: Color(0xff82d5ca),
      onColor: Color(0xff003732),
      colorContainer: Color(0xff005049),
      onColorContainer: Color(0xff9ef2e6),
    ),
